...
import Cookies from 'universal-cookie';
  ...
  return (
    ...
    <div className='max-w-7xl mx-auto py-20'>
        ...
        <div>
        <button type="button" onClick={()=>{navigate('/addblog')}} class="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Add a blog</button>
             </div>

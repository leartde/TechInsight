    ...
    <div className='mt-24 mx-auto max-w-7xl  '>
        <div className='pt-24 border bg-stone-50  flex flex-row pb-24 '>
           ...
           {tags.map((tag, index) => (
            <input
              key={index}
              className='w-1/4 p-2.5 border-2 border-gray-400 text-sm rounded-lg bg-white placeholder-gray-400 text-black focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-gray-400'
              type="text"

          ...
          <div className="mt-5">
            <form onSubmit={handleSubmit}>
              ...
              <div className="my-6">
                <button
                  type="submit"
                  className="w-full rounded-md bg-[#009bd6] px-3 py-4 text-white focus:bg-gray-600 focus:outline-none hover:bg-[#4597b8]"
                >
                  Sign in
                </button>
              </div>
              <p className="text-center text-sm text-gray-500">
                ...
                <a href="/signup" className="font-semibold text-blue-500 hover:underline focus:text-gray-800 focus:outline-none">
                  Sign up
                </a>
                .
              </p>

            ...
            <div className="my-6">
                ...
                <div className="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif] mt-40">
                    <div>
                        ...
                        <p className="text-sm text-gray-400 mt-3"> Have questions, suggestions, or just want to chat? We'd love to hear from you! Fill out the form or connect with us through social media.</p>
                        <div className="mt-12">
                            ...
                            <ul className="mt-3">
                                <li className="flex items-center">
                                    ...
                                    <a href="/" className="text-[#007bff] text-sm ml-3">
                                        ...
                                        <strong>info@techinsight.com</strong>
                                    </a>
                                </li>
                            </ul>
                        </div>

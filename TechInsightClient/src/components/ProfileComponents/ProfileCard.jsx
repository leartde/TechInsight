...
const ProfileCard = ({ user }) => {
  return (
    <div className="w-2/3 max-w-sm mx-auto  bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden transform hover:scale-105 transition-transform duration-300">
